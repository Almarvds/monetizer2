            ...
            <Row>
              <Col>
                <Fade left duration={2000} distance={'8vh'}>
                  <img src='/static/demonetized_sign.png' style={{marginTop:'15vh',height: '40vh',width:'40vh'}}/>
                </Fade>
              </Col>
              <Col>
                <Fade right duration={2000} distance={'15vh'}>
                  <Container style={{marginTop:'15vh', marginBottom:'20vh'}}>
                    <p>
